...
class MedNeXt(nn.Module):
    ...
    def __init__(self, 
        ...
        # ---------------- Global Context ----------------
        self.gc2 = GlobalContext3D(n_channels * 4)
        self.gc3 = GlobalContext3D(n_channels * 8)
        self.gc4 = GlobalContext3D(n_channels * 16)
        ...
        self.fusion3 = CrossAttentionFusion(n_channels * 8)
        self.fusion2 = CrossAttentionFusion(n_channels * 4)
        self.fusion1 = CrossAttentionFusion(n_channels * 2)
        self.fusion0 = CrossAttentionFusion(n_channels)
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            dec_x = self.fusion3(x_res_3, x_up_3) 
            ...
            dec_x = self.fusion2(x_res_2, x_up_2) 
            ...
            dec_x = self.fusion1(x_res_1, x_up_1) 
            ...
            dec_x = self.fusion0(x_res_0, x_up_0) 
